...
$execute if data block $(x) $(y) $(z) Items[0].components."minecraft:custom_data".directive{command:"selfrepair"} run return run function directive:golem/slip/interaction/selfrepair

$execute if data block $(x) $(y) $(z) Items[0].components."minecraft:custom_data".directive{command:"pickup_item"} run return run function directive:golem/slip/interaction/pickup_item
